 ...
 * @consumer hab, which declares the service's `yrd queue up --interval <n>`
 *
 ...
 * change already checked and waiting behind it. The interval itself is
 * unchanged here — this decision is what stops it being spent on ready work,
 * and it holds at any cadence.
 */
