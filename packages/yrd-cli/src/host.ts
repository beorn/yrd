...
/** Run the process entrypoint with the built-in TTY renderer and injected host capabilities. */
export function runYrdProcessWith(
  options: YrdProcessOptions,
  argv: readonly string[] = process.argv,
): Promise<YrdCliExitCode> {
  return runYrdProcess(argv, defaultIO(), options)
}
