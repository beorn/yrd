...
export function queueTimelineProjection(
  ...
  // month) off the SAME consolidated queueFlowMetrics aggregate, so it folds
  // every retained completed Run regardless of the display `--since` window and
  // re-windows per box. Unfiltered by the operator's view so a health readout
  // never hides failures behind a status/term filter.
