 ...
 * M5, "one declaration parser"). Everything past "does this file name a
 * `remote:`" is `@yrd/queue-core`'s `hintsIn`/`readConfig`, and the target's
 * declaration, never this one, is the authority for a judgement.
 */
