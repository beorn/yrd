...
10,000 Frames. The warning points to the pre-created, as-needed compaction
maintenance bead. These thresholds are reminders to implement compaction, not
configuration knobs to raise when replay becomes slow.
