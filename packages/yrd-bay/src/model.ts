 ...
 * rejected; once it reaches a terminal status
 * (integrated/already-landed/withdrawn/canceled) it is no longer checkable. */
...
export type PRRevisionTerminal = Readonly<{
  status: Extract<PRStatus, "rejected" | "integrated" | "already-landed" | "withdrawn" | "canceled">
  at: string
  run?: string
}>
