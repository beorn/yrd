  ...
  return <State extends object, Commands extends CommandTree, Features extends HasJobs>(
    ...
    definition.extend({
      ...
      eventVersions: {
        ...
        "bay/closing": 1,
        "bay/orphaned": 1,
        "bay/handoff-certified": 1,
        "pr/pushed": 1,
        "pr/recut": 1,
        "pr/submitted": 1,
        "pr/correlation-bound": 1,
        "pr/withdrawn": 1,
        "pr/needs-author": 1,
        "pr/rejected": 1,
        "pr/terminal-associated": 1,
        "pr/integrated": 1,
        "pr/already-landed": 1,
        "pr/canceled": 1,
        "pr/regression-recorded": 1,
        "pr/edited": 1,
        "pr/reviewed": 1,
        "pr/commented": 1,
        "pr/session-started": 1,
        "pr/session-ended": 1,
        "pr/checks-requested": 1,
        "pr/admission-recorded": 2,
        "pr/review-requested": 1,
      },
      replayEvents: {
