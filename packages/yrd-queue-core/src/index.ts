...
export { checkedTree, freshWorktree, prepareWorktree, SETUP, SetupFailed } from "./worktree.ts"
export type { PreparedWorktree, PrepareWorktree, SetupRan, SetupSpec, Worktree } from "./worktree.ts"
