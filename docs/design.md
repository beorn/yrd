...
- Content-addressed source-candidate refs have a **minimum seven-day retention
  ...
  window, only a future Yrd-owned collector may make a ref eligible for deletion, and
  only from a fresh complete inventory proving all of the following: the ref is
